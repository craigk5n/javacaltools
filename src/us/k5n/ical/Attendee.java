...
/**
  * iCal Attendee class -
  * This object represents either an individual or
  * a resource and corresponds to the ATTENDEE iCal property.
  * @version $Id$
...
public class Attendee extends Property
{
  ...
  /** specify whether there is an expectation of a favor of a
    * reply from the calendar user */
  ...
  /**
    ...
    *			an event attendee
    */
  public Attendee ( String icalStr )
  ...
  /**
    ...
    */
  public Attendee ( String icalStr, int parseMode )
    throws ParseException
  {
...
System.out.println ( "Ignoring unknown attribute '" + a.name + "'" );
  ...
  // into ical format.
  // Usage: java Attendee "ATTENDEE;ROLE=CHAIR:MAILTO:joe@xxx.com"
  //   
