...
/**
  * iCal Event class that corresponds to the VEVENT iCalendar
  * object.
  * @version $Id$
  ...
  implements Constants
{
  ...
  /**
    * Create an Event object based on the specified iCal data
    * @param parser	The IcalParser object
    * @param initialLine	The starting line number
    * @Param textLines	Vector of iCal text lines
    */
  public Event ( IcalParser parser, int initialLine, Vector textLines )
  {
  ...
  /**
    ...
    * @param startDate		The date of the event in ISO 8601 format
    *				(19991231, 199912310T115900, etc.)
    */
  public Event ( String summary, String description,
    Date startDate )
  {
...
System.out.println ( "Ignoring: " + icalStr );
  ...
  /**
    * Get the event summary for the specified language.
  ...
  /**
    * Convert this Event into iCal text
    */
