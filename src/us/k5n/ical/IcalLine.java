...
/**
 * This class represents one or more text lines of iCalendar data that have been
...
class IcalLine {
	...
	public String value;
	/** The starting line number in the originial iCalendar data for this text */
