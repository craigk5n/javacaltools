...
public class Contact extends Property {
	 ...
	 * 
	 * @param icalStr
	 *          One or more lines of iCalendar that specifies contact information
	 */
	public Contact(String icalStr) throws ParseException {
	 ...
	 */
	public Contact(String icalStr, int parseMode) throws ParseException {
